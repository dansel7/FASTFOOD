				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          $qry_categorias = "SELECT
                                    categoria,icono,modifica,
                                    id_categoria
                                    FROM categorias_productos";
                          
                            $result_menusection = $conexion->enviarQuery($enlace, $qry_categorias);
                            if($conexion->countRows($result_menusection) > 0){
                                    while($row = mysql_fetch_array($result_menusection)){
                                      echo '<tr>
                                    <td>'.$row["categoria"].'</td>
                                    <td class="center"><img src="../icon_categorias/'.$row["icono"].'"></td>
                                    <td class="center">'.$row["modifica"].'</td>
                                    <td class="center">
                                        <a class="btn btn-success" href="mantto-edit/edit-categorias.php">
                                                    <i class="icon-zoom-in icon-white"></i>  
                                                    Nuevo                                            
                                            </a>
                                            <a class="btn btn-info" href="mantto-edit/edit-categorias.php?idcat='.$row["id_categoria"].'">
                                                    <i class="icon-edit icon-white"></i>  
                                                    Edit                                            
                                            </a>
                                            <a class="btn btn-danger" href="mantto-del/del-categorias.php?idcat='.$row["id_categoria"].'">
